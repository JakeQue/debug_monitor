...
while {debugMonitor} do
{
	...
	<t size='1.2' font='Zeppelin33' align='center' color='#D9FF00'>%8</t>
	<br/>
	<br/>
	<t size='1' font='Zeppelin33' align='left' color='#8CFA16'>GPS:</t><t size='1' font='Zeppelin33' align='left' color='#FFFFFF'> %9</t>
	<t size='1' font='Zeppelin33' align='right' color='#8CFA16'>FPS:</t><t size='1' font='Zeppelin33' align='right' color='#FFFFFF'> %10</t>
	<br/>
	<t size='1' font='Zeppelin33' align='left' color='#FA1A16'>Blood:</t><t size='1' font='Zeppelin33' align='left' color='#FFFFFF'> %5</t>
	<t size='1' font='Zeppelin33' align='right' color='#7FBDE3'>Temp:</t><t size='1' font='Zeppelin33' align='right' color='#FFFFFF'> %13</t>
	<br/>
	<t size='1' font='Zeppelin33' align='left' color='#D6A24D'>Food:</t><t size='1' font='Zeppelin33' align='left' color='#FFFFFF'> %11</t>
	<t size='1' font='Zeppelin33' align='right' color='#7FBDE3'>Drink:</t><t size='1' font='Zeppelin33' align='right' color='#FFFFFF'> %12</t>
	<br/>
	<br/>
	...
	<br/>	
	<br/>
	<t size='0.9' font='Zeppelin33' align='center' color='#FFFFFF'>Restart in </t><t size='0.9' font='Zeppelin33' align='center' color='#FFFFFF'>%14 hr(s) %15 mins</t>
	",
		...
		dayz_playerName,																										//%8					
		(mapGridPosition getPos player),																				//%9
        round diag_FPS,																											//%10	
		ceil ((1 - ((dayz_hunger min SleepWater) / SleepWater)) * 100),								//%11
		ceil ((1 - ((dayz_thirst min SleepFood) / SleepFood)) * 100),										//%12
		(round(dayz_temperatur)),																							//%13
		_hours, 																														//%14
		_minutes 																													//%15
	];
    sleep 1;
